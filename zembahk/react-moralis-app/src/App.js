...
//placeholder code
function loadImage() {
  return fetch("https://js3d87qgmd.execute-api.us-east-1.amazonaws.com/test/helloworld")
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <p>
            <div>
              <button class="button authenticateButton" enabled={isWeb3Enabled} onClick={() => authenticate()}>Authenticate</button>
            </div>
          </p>
        </header>
      </div>
