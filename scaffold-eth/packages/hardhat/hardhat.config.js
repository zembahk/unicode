...
module.exports = {
  ...
  // Include local uniswap
  //external: {
    //contracts: [
      //{
        //artifacts: '../../../hardhat-deploy-test-uniswap/artifacts/localhost',
        //deploy: '../../../hardhat-deploy-test-uniswap/deploy',
      //},
    //],
  //},
  ...
  networks: {
    //hardhat: {
      //forking: {
        //url: "https://eth-mainnet.alchemyapi.io/v2/EvcQGKMnrY9rd70N-mwRoFMo2hcZW45R",
      //},
    //},
    localhost: {
      forking: {
